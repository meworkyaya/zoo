...
namespace DbBest.ZooPark
{
    public class Zoo
    {
        ...
        public bool FindFoodSolution()
        {
            ...
            // 4) если какого то корма (1) не хватает, связанного корма (2) тоже нет, но есть излишек парного корма (3) для связанного (2) - то надо втолкнуть корм (3) чтобы освободить корм (2), и заполнить им пустоту для корма (1)
