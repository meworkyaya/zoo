...
namespace DbBest.ZooPark
{
    public class Zoo
    {
        ...
        public bool FindFoodSolution()
        {
            ...
            // каждый бакет - сязываем с набором других бакетов в которые мы можем залить еду - втолкнув еду в первый бакет
            ...
            // 2) после этого будут заполнены половины кормов которых с избытком, не будет заполнены половины которых не хватает, на складе останутся избыточные корма и промежуточные корма.. 
